...
Дизайн — проєкт Claude Design **«Health Hub Light»**. Дані — виключно живий стан Home Assistant
і читання з recorder’а. Карта **нічого не пише**: жодних викликів сервісів, жодних змін у базі.
Історичні дані в HA лишаються недоторканими.

![сторінок](https://img.shields.io/badge/сторінок-10-B45309)
![режим](https://img.shields.io/badge/режим-read--only-2E7D5B)
...
Він проходить усі десять сторінок і ловить помилки рендера до встановлення в HA:
